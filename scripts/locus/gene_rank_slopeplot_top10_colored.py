...
# Save top genes summary CSV
top_genes_df = pd.DataFrame(top_genes_summary)
top_genes_df.to_csv(os.path.join(output_dir, "top_genes_per_patient.csv"), index=False)
