...
for patient in patients:
    ...
    print(f"Sample columns for {patient}:", sample_cols)  # Debugging statement
    if not sample_cols:
        continue
    patient_gene_matrix = gene_matrix[sample_cols].T
    print(f"Patient gene matrix for {patient}:\n", patient_gene_matrix)  # Debugging statement
    ...
    print(f"Grouped data for {patient}:\n", grouped)  # Debugging statement
