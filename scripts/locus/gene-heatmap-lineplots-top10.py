...
top_genes = gene_matrix.var(axis=1).sort_values(ascending=False).head(10).index.tolist()
...
for patient in patients:
    ...
    top_genes = grouped_full.var(axis=1).sort_values(ascending=False).head(10).index.tolist()
...
gene_matrix.to_csv(os.path.join("output", "top10_gene_matrix.csv"))
