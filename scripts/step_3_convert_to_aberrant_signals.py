...
# STEP4: Divide the values in the output_glob20 file by the corresponding values in the output_globmin80 file and multiply by 100000
ratio_df = (glob20_filtered.iloc[:, 1:].astype(float) / globmin80_filtered.iloc[:, 1:].astype(float)) * 100000
